...
(function (h) {
    ...
    function pb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures, g = '<input type="search" class="' + b.sFilterInput + '"/>', j = d.sSearch, b = h("<div/>", {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "Đầu", sLast: "Cuối", sNext: "Trước", sPrevious: "Sau"},
            sEmptyTable: "Không có dữ liệu",
            sInfo: "Hiển thị _START_ tới _END_ của _TOTAL_ kết quả",
