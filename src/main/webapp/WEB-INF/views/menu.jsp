...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <div class="navbar-brand-top-logo">
            <img src="../static/img/logo_hackademicsvn.png" class="navbar-brand-logo" alt="Cinque Terre">
        </div>
    ...
    <div class="sidebar-menu" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav-menu" id="side-menu">
                ...
                <li>
                    <a href="forms.html">Giảng Viên Trợ Giảng</a>
                </li>
                <li>
